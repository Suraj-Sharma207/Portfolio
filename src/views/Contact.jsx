...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_msb166f", // replace with your EmailJS Service ID
        "template_cfzpvmw", // replace with your EmailJS Template ID
        form.current,
        "7Z_VZSaBlm67WLj9r" // replace with your EmailJS Public Key
      )
      .then(
        (result) => {
